...
public class CompanyBuilder {
    ...
    public static final String DEFAULT_NAME = "Example Trading PTE LTD";
    public static final String DEFAULT_PHONE = "67676767";
    public static final String DEFAULT_EMAIL = "example@company.com";
