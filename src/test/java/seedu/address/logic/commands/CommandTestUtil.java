...
public class CommandTestUtil {
    ...
    public static final String VALID_ADDRESS_BOEING = "Block 123, Boeing Street 3";
    ...
    public static final String INVALID_NAME_DESC = " " + PREFIX_NAME + "Amazon&"; // '&' not allowed in names
    ...
    public static final EditCommand.EditCompanyDescriptor DESC_APPLE;
    public static final EditCommand.EditCompanyDescriptor DESC_BOEING;

    static {
        DESC_APPLE = new EditCompanyDescriptorBuilder().withName(VALID_NAME_APPLE)
